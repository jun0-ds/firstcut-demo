...
(function () {
  ...
  // 2026 수능 표준→원 변환 (과목별, 공식 역산)
  // 국어/수학: 표준=round((원-μ)/σ×20+100), 탐구: 표준=round((원-μ)/σ×10+50)
  // μ,σ는 만점+1등급컷 앵커로 역산, 등급컷 표준점수를 매핑 포인트로 사용
  var STD_TO_RAW_MAPPINGS = {
    ...
    "수학": [
      ...
      [111, 69], [92, 49], [79, 35], [74, 29], [71, 26]
    ],
    "물리학Ⅰ": [
      [70, 50], [66, 47], [64, 46], [60, 42],
      [53, 37], [46, 32], [41, 28], [38, 26], [35, 24]
    ],
    "화학Ⅰ": [
      [71, 50], [67, 45], [64, 41], [59, 35],
      [52, 26], [46, 19], [41, 12], [38, 9], [36, 6]
    ],
    "생명과학Ⅰ": [
      [74, 50], [67, 43], [63, 39], [59, 35],
      [54, 30], [47, 23], [42, 18], [37, 13], [33, 9]
    ],
    "지구과학Ⅰ": [
      [68, 50], [65, 44], [63, 40], [59, 32],
      [54, 22], [46, 6], [40, 0]
    ],
    "생활과 윤리": [
      [71, 50], [66, 44], [64, 42], [59, 36],
      [53, 28], [46, 20], [42, 15], [36, 8], [33, 4]
    ],
    "사회·문화": [
      [70, 50], [65, 43], [62, 39], [59, 35],
      [54, 28], [47, 18], [41, 9], [36, 2], [33, 0]
    ],
    "한국지리": [
      [72, 50], [68, 46], [65, 43], [59, 37],
      [52, 30], [45, 23], [41, 19], [39, 17], [36, 14]
    ],
    "세계지리": [
      [73, 50], [68, 46], [63, 42], [59, 39],
      [53, 34], [45, 28], [40, 24], [38, 22], [35, 20]
    ]
  };
